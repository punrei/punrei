...
ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ    $\color{#7E7F86}{Honestly,}$ $\color{#888991}{I'm}$ $\color{#9294A0}{kinda}$ $\color{#9C9DAF}{bad}$ $\color{#A7A8BC}{at}$ $\color{#B2B3C6}{chatting,}$ $\color{#BEC0CE}{and}$ $\color{#C2C4CE}{I}$ $\color{#BEBBBF}{don't}$ $\color{#B8B1AF}{type}$ $\color{#AEA5A1}{much}$
